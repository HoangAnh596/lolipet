        ...
        <div class="card card-white my-0">
            <div class="card-header">
                <ol class="breadcrumb float-sm-left ">
                    <li class="breadcrumb-item"><a class="card-title" href="{{route('age.index')}}">Danh sách tuổi</a>
                    </li>
                    <li class="breadcrumb-item active">Tạo tuổi</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="age" id="age" class="form-control" placeholder="Tuổi">
