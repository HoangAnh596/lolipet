        ...
        <div class="card card-white my-0">
            <div class="card-header">
                <ol class="breadcrumb float-sm-left ">
                    <li class="breadcrumb-item"><a class="card-title" href="{{route('coupon.index')}}">Danh sách mã
                            giảm giá</a></li>
...
<section class="content">
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Thông tin mã giảm giá</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input type="text" name="discount" class="form-control" placeholder="Nhập vào giá trị giảm giá">
                                    </div>
